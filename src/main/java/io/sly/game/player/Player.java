...
import static io.sly.game.player.Faction.FACTIONS;
...
import io.sly.game.entities.controllables.buildings.Building;
import io.sly.game.entities.controllables.buildings.House;
import io.sly.game.entities.controllables.buildings.Townhall;
import io.sly.game.map.Map;
import io.sly.game.player.factions.FType;
